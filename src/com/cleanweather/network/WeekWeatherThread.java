...
public class WeekWeatherThread extends WeatherThread {

	@Override
	public void run() {
		// TODO Auto-generated method stub
		String url = WeatherCNConnectURLUtil.getConnectUrl(cityModel, SearchType.WEATHERWEEK);
		...
		if(jsonArray!=null){
			...
			boolean success = WeatherCNConnectURLUtil.connvertToModel(jsonArray,detailModel,SearchType.WEATHERWEEK);
